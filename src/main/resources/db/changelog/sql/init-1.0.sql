INSERT INTO BANKS
VALUES ('2ebf6b62-069b-496b-89f1-c4b4b08e04ae', 'Lion', 'Lion', 'Lion Bank Ltd.', '/images/bank/lion.svg',
        'https://api.lion.mlabs.dpc.hu:8243/token', 'https://api.lion.mlabs.dpc.hu:8243/open-banking/v3.1/aisp/v3.1.2',
        'Jg7O55zbOOlJiSJOaG9Qm5nq7qsa', 'rEpxSqsEJUUGrJt8dcWsvAxIhx8a', 'https://acefintech.api.mlabs.dpc.hu/callback',
        'acefintech', 'https://api.lion.mlabs.dpc.hu:8243/authorzize');
INSERT INTO BANKS
VALUES ('7be1e4c4-c714-409b-b43c-e273b14e3ced', 'Local Lion', 'Lion', 'Lion Bank Ltd.', '/images/bank/lion.svg',
