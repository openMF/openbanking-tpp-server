...
public class OBWriteInternationalStandingOrderResponse4Data {
    ...
    public OBWriteInternationalStandingOrderResponse4Data charges(List<OBWriteDomesticStandingOrderResponse4DataCharges> charges) {
        this.charges = charges;
        return this;
    }

    public OBWriteInternationalStandingOrderResponse4Data addChargesItem(OBWriteDomesticStandingOrderResponse4DataCharges chargesItem) {
     ...
     **/
    @JsonProperty("InternationalStandingOrderId")
    @ApiModelProperty(value = "OB: Unique identification as assigned by the ASPSP to uniquely identify the international standing order resource.")
    @Size(min = 1, max = 40)
    ...
    public OBWriteInternationalStandingOrderResponse4Data initiation(OBWriteInternationalStandingOrderConsent4DataInitiation initiation) {
    ...
    public OBWriteInternationalStandingOrderResponse4Data multiAuthorisation(OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation multiAuthorisation) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(status, statusUpdateDateTime, creationDateTime, charges, internationalStandingOrderId, consentId, initiation, multiAuthorisation);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.status, obWriteInternationalStandingOrderResponse4Data.status) &&
