...
public class OBWriteDomesticScheduled2DataInitiationCreditorAccount {
    ...
    public OBWriteDomesticScheduled2DataInitiationCreditorAccount secondaryIdentification(String secondaryIdentification) {
    ...
    public OBWriteDomesticScheduled2DataInitiationCreditorAccount schemeName(String schemeName) {
    ...
    public OBWriteDomesticScheduled2DataInitiationCreditorAccount identification(String identification) {
    ...
    public OBWriteDomesticScheduled2DataInitiationCreditorAccount name(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OBWriteDomesticScheduled2DataInitiationCreditorAccount obWriteDomesticScheduled2DataInitiationCreditorAccount = (OBWriteDomesticScheduled2DataInitiationCreditorAccount) o;
        return Objects.equals(this.secondaryIdentification, obWriteDomesticScheduled2DataInitiationCreditorAccount.secondaryIdentification) &&
                Objects.equals(this.schemeName, obWriteDomesticScheduled2DataInitiationCreditorAccount.schemeName) &&
                Objects.equals(this.identification, obWriteDomesticScheduled2DataInitiationCreditorAccount.identification) &&
                Objects.equals(this.name, obWriteDomesticScheduled2DataInitiationCreditorAccount.name);
    }
